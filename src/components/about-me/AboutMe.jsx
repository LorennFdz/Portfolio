  ...
  return (
    ...
    <section className='content-about-me'>
      <article className='article-about-me'>
        <p className='text-one'>Soy Lorenzo Fernández, un <span>desarrollador web</span> con 25 años de edad, en constante aprendizaje. Desde que empecé a programar, me apasiona crear soluciones digitales que faciliten la vida de las personas.</p>
        <p className='text-two'>Durante mis estudios, he desarrollado varios proyectos personales, desde un <span>e-commerce simulado y una landing page de productos tecnológicos, hasta una página web para la ONG 'Mesa Solidaria Tandil'.</span> Estos proyectos me han permitido poner en práctica mis conocimientos de <span>JavaScript y React</span>, como también <span>Java, Spring Boot y MySQL</span>, y han sido una excelente oportunidad para aprender a trabajar de forma independiente y resolver problemas.</p>
