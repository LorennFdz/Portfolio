  ...
  return (
    ...
    <section className='content-about-me'>
      <article className='article-about-me'>
        ...
        <p className='text-two'>Durante mis estudios, he desarrollado varios proyectos personales, desde un <span>e-commerce simulado hasta una landing page de productos tecnológicos.</span> Estos proyectos me han permitido poner en práctica mis conocimientos de <span>JavaScript y React</span>, como también <span>Java, Spring Boot y MySQL</span>, y han sido una excelente oportunidad para aprender a trabajar de forma independiente y resolver problemas.</p>
