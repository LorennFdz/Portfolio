...
export const AboutMe = () => {
  return (
    ...
    <section className='content-about-me'>
      ...
      <p>Durante mis estudios, he desarrollado varios proyectos personales, desde un <span>e-commerce simulado y una landing page de productos tecnológicos, hasta una página web para la ONG 'Mesa Solidaria Tandil'.</span> Estos proyectos me han permitido poner en práctica mis conocimientos de JavaScript y React, como también Java, Spring Boot y MySQL, y han sido una excelente oportunidad para aprender a trabajar de forma independiente y resolver problemas.</p>
